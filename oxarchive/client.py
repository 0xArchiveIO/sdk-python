...
class Client:
    ...
    - `client.rh_lighter` - Lighter on Robinhood Chain (USDG-quoted perps and
      spot; trades from 2026-06-26, order book, OI and funding from 2026-08-22)
    ...
    def __init__(
        ...
        *,
        ...
        liquidations from 2026-06-26 20:10:26 UTC; order book, open interest and
        funding from 2026-08-22 18:43 UTC. Same resources as ``client.lighter``
